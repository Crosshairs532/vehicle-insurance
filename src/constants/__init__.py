...
MONGODB_URL_KEY = "mongodb+srv://admin:KdqbhZulPlXQNa1O@ml-clusters.qazmdxn.mongodb.net/Vehicle-Insurance?retryWrites=true&w=majority&appName=Ml-clusters"
...
MODEL_BUCKET_NAME = "nawrinbucket"
