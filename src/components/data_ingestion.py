...
from src.data_access.VehicleInsuranceData import VehicleInsuranceData
...
class DataIngestion:
    def __init__(self, data_ingestion_config: DataIngestionConfig = DataIngestionConfig()):
        try:
            ...
            logger.error('Error happened at Data Ingestion Initialization')
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        logger.info("Entered initiate data ingestion method of DataIngestion class")
